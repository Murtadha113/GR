      ...
      <div className="p-8 space-y-8">
        ...
        {!canSubmit && (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              لا يمكنك تقديم فكرة جديدة حالياً. لديك فكرة قيد المراجعة أو تمت الموافقة عليها. يمكنك تقديم فكرة جديدة فقط
              إذا تم رفض فكرتك السابقة.
            </AlertDescription>
          </Alert>
        )}
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-4">
                <Button type="submit" disabled={loading || !canSubmit} className="rounded-lg">
