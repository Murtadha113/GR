...
import { Home, FolderKanban, Users, ClipboardCheck, Calendar, User, Save, Key } from "lucide-react"
...
const sidebarItems = [
  ...
  { title: "الملف الشخصي", href: "/supervisor/profile", icon: <User className="w-5 h-5" /> },
  ...
  { title: "التقييمات", href: "/supervisor/evaluations", icon: <ClipboardCheck className="w-5 h-5" /> },
