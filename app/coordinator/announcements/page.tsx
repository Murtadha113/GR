...
import { Home, FolderKanban, Lightbulb, Megaphone, Plus, Pin, Trash2, Archive } from "lucide-react"
...
const sidebarItems = [
  ...
  { title: "الإعلانات", href: "/coordinator/announcements", icon: <Megaphone className="w-5 h-5" /> },
