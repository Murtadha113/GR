...
import { Home, FolderKanban, Users, FileText, Bell, Plus, UserPlus } from "lucide-react"
...
const sidebarItems = [
  ...
  { title: "الإعلانات", href: "/coordinator/announcements", icon: <Bell className="w-5 h-5" /> },
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="rounded-xl">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="supervisorId">الرقم الوظيفي *</Label>
                    <Input
                      id="supervisorId"
